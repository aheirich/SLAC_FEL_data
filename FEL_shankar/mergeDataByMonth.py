...
FEL_INPUT = open('FEL_INPUT_MONTHLY.py', 'w')
FEL_OUTPUT = open('FEL_OUTPUT_MONTHLY.py', 'w')
    ...
    if not first:
      ...
      if month != currentMonth:
        ...
        if currentMonth > -1:
          FEL_INPUT.write("])\n")
          FEL_OUTPUT.write("])\n")
        FEL_INPUT.write("\nFEL_INPUT_" + months[month - 1] + " = numpy.array([\n")
        FEL_OUTPUT.write("\nFEL_OUTPUT_" + months[month - 1] + " = numpy.array([\n")
        currentMonth = month
